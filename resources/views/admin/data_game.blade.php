                    ...
                    <tbody>
                        @foreach ($data as $data)
                            <tr>
                                ...
                                <td>{{ $data->harga }}</td>
                                <td>{{ $data->genre }}</td>
                                <td>{{ $data->seleksi_game }}</td>
                                <td>
                                    <img width="75" src="game/{{ $data->gambar }}" alt="">
                                </td>
                                <td>
                                    <a class="btn btn-outline-warning" href="{{ url('update_game', $data->id) }}">Update</a>
                                </td>
                                <td>
                                    <a onclick="return confirm('Apakah anda ingin menghapus game?')" class="btn btn-outline-danger" href="{{ url('delete_game', $data->id) }}">Delete</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
